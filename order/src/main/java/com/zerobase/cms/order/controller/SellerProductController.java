...
public class SellerProductController {
  ...
  public ResponseEntity<ProductDto> addProductItem(
      @RequestHeader(name = "X-AUTH-TOKEN") String token, @RequestBody AddProductItemForm form) {
  ...
  public ResponseEntity<ProductDto> updateProduct(
      @RequestHeader(name = "X-AUTH-TOKEN") String token, @RequestBody
  ...
  @DeleteMapping("/item")
  public ResponseEntity<Void> deleteProductItem(@RequestHeader(name = "X-AUTH-TOKEN") String toke,
      @RequestParam Long productItemId) {

    productItemService.deleteProductItem(provider.getUserVo(toke).getId(), productItemId);
    return ResponseEntity.ok().build();
  }
